...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="../billsys/admin/admin.css">
      <title>Invoice</title>
      <style>
         @media print{
            body * {
   ...
   <header class="header">
      ...
      <section class="mt-3">
         ...
         <h4 class="text-center" style="color:green">TWO WHEELER BILLING SYSTEM</h4>
                  ...
                  <div class="row">
                     ...
                     <table id="receipt_bill" class="table">
                        <thead>
                           <tr>
                              <th> No.</th>
                              <th class="parts_name" id="parts_name">Parts Name</th>
                              <th class="qty" id="qty">Quantity</th>
